...
const generateWAMessageContent = async (message, options) => {
    ...
    if ('text' in message) {
        ...
        m.eventMessage.isCanceled = (_a = message.event.isCancelled) !== null && _a !== void 0 ? _a : false;
        m.eventMessage.extraGuestsAllowed = message.event.extraGuestsAllowed;
        m.eventMessage.isScheduleCall = (_b = message.event.isScheduleCall) !== null && _b !== void 0 ? _b : false;
