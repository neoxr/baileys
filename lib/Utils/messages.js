...
import { downloadContentFromMessage, encryptedStream, generateThumbnail, getAudioDuration, getAudioWaveform, getImageProcessingLibrary, getStream, getRawMediaUploadData, toBuffer } from './messages-media.js';
const MIMETYPE_MAP = {
    image: 'image/jpeg',
    video: 'video/mp4',
...
async function prepareStickerPackMessage(stickerPack, options) {
    ...
    // Abu@Note 03-03-22 --- Wrapped sticker conversion in try/catch to skip failing stickers, logs warnings, filters nulls.
