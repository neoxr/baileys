...
const makeMessagesRecvSocket = (config) => {
            ...
            await Promise.all([
                processingMutex.mutex(async () => {
                    ...
                    if (msg) {
                        ...
                        const fullMsg = WAProto_1.proto.WebMessageInfo.create(msg);
            ...
            await Promise.all([
                processingMutex.mutex(async () => {
                    ...
                    if (msg.messageStubType === WAProto_1.proto.WebMessageInfo.StubType.CIPHERTEXT) {
                        ...
                        console.debug("\x1b[34m[handleMessage] Attempting retry request for failed decryption\x1b[0m");
    ...
    ev.on('call', ([call]) => {
        ...
        if (call.status === 'timeout' || (call.status === 'offer' && call.isGroup)) {
            ...
            const protoMsg = WAProto_1.proto.WebMessageInfo.create(msg);
